    ...
    constructor(namespace: string) {
        ...
        if (data) {
            try {
                ...
                throw new CalendarError(`Couldn't create Calendar object, error: ${err}`);
            }
        } else {
            throw new CalendarError(`Couldn't create Calendar object, there is no data with namespace: ${namespace}`);
        }
    }
