...
describe("Test for checking LocalStorage API", () => {
    ...
    it("Check constructor, getTask and addTask methods", async () => {
        ...
        expect(() => new Calendar("TEST_ERROR")).toThrow(new CalendarError("Couldn't create Calendar object, error: SyntaxError: Unexpected token 'N', \"NOT A JSON STRING\" is not valid JSON"));
    })
