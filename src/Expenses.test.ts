...
describe("Expenses class tests", () => {
  ...
  it("Check getExpensesByCategories funciton", () => {
    ...
    expect(expenses.getExpensesByCategories(start, end)).toStrictEqual(
      expected,
    );

    expected.sort((a, b) => (a.sum < b.sum ? -1 : a.sum > b.sum ? 1 : 0));
    expect(expenses.getExpensesByCategories(start, end, "asc")).toStrictEqual(
      expected,
    );

    expected.sort((a, b) => (a.sum < b.sum ? 1 : a.sum > b.sum ? -1 : 0));
    expect(expenses.getExpensesByCategories(start, end, "dsc")).toStrictEqual(
      expected,
    );
  });
  ...
  it("Check getExpensesByDay funciton", () => {
    [
      {
        date: new Date("2024-01-01T04:00:00"),
        sum: 1,
        subcategoriesId: 0,
        comment: "test",
      },
      {
        date: new Date("2024-01-01T05:00:00"),
        sum: 1,
        subcategoriesId: 0,
        comment: "test",
      },
      {
        date: new Date("2024-01-02T04:00:00"),
        sum: 2,
        subcategoriesId: 0,
        comment: "test",
      },
      {
        date: new Date("2024-01-03T04:00:00"),
        sum: 3,
        subcategoriesId: 0,
        comment: "test",
      },
      {
        date: new Date("2024-01-04T04:00:00"),
        sum: 4,
        subcategoriesId: 0,
        comment: "test",
      },
      {
        date: new Date("2024-01-05T04:00:00"),
        sum: 5,
        subcategoriesId: 0,
        comment: "test",
      },
      {
        date: new Date("2024-01-05T05:00:00"),
        sum: 5,
        subcategoriesId: 0,
        comment: "test",
      },
